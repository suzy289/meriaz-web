import { Service, Metric, Testimonial, Reference } from './types'
...
export const hero = {
  ...
  primaryCta: { text: 'Créer mon site dès maintenant', href: '/devis/form' },
...
export const services: Service[] = [
  {
    ...
    ctaLink: '/devis/form?service=site-pro',
    imagePlaceholder: '/images/devis/services/site-pro.png',
    isSpecial: true
  },
  {
    id: 'erp-saas',
    ...
    ctaLink: '/devis/form?service=erp-saas',
    imagePlaceholder: '/images/devis/services/erp.png'
  },
  {
    id: 'ia-automation',
    icon: 'Cpu',
    ...
    ctaLink: '/devis/form?service=ia-automation',
    imagePlaceholder: '/images/devis/services/ia.png'
  },
  {
    id: 'microfinance',
    ...
    ctaLink: '/devis/form?service=microfinance',
    imagePlaceholder: '/images/devis/services/microfinance.png'
  },
  {
    id: 'wemoni',
    badge: 'Produit Meriaz',
    icon: 'Smartphone',
    title: 'Wemonii (Digital Banking)',
    description:
      'La solution clé en main pour lancer vos services financiers numériques (Wallet, Transferts, Paiements).',
    features: [
    ...
    ctaText: 'Lancer ma banque digitale',
    ctaLink: '/devis/form?service=wemoni',
    imagePlaceholder: '/images/devis/services/wemoni.png'
  }
]
