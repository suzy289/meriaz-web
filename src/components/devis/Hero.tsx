import { hero, metrics } from '@/lib/devis/constants'
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-40 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/images/devis/hero/corporate-bg.jpg')",
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      />
      
      {/* Overlay - Meriaz Blue with opacity */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/90 via-blue-900/80 to-slate-900/90 z-0" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center w-full sm:w-auto mb-16">
          <a href={hero.primaryCta.href} className="px-8 py-4 rounded-xl text-lg font-bold shadow-xl shadow-blue-950/50 hover:shadow-2xl hover:shadow-blue-900/50 transition-all transform hover:-translate-y-1 bg-white text-blue-900 hover:bg-blue-50 border-none">
            {hero.primaryCta.text}
          </a>
          <a href={hero.secondaryCta.href} target="_blank" rel="noopener noreferrer" className="px-8 py-4 text-lg font-semibold text-white border-2 border-white/30 rounded-xl hover:bg-white/10 transition-colors backdrop-blur-sm flex items-center justify-center gap-2">
